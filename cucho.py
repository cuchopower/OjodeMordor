...
# ID del archivo JSON en Google Drive (activos para “cucho”)
DRIVE_FILE_ID = "1ktZ415nIiB-vfk0VCqrzNuTnsBAlbEzz"
...
def evaluar_alertas(activos):
    ...
    print(f"\n📡 Evaluando [CUCHO]: {hora_local} ({estado_mercado()})")
    ...
    for a in activos:
        ...
        for m in mensajes:
            ...
            alerta = f"[CUCHO] {m} – {hora_simple} {TZ_LOCAL}"
            print(alerta)
